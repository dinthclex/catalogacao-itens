 ...
 *     textura é gerada com o MESMO código de `js/objecttypes/mostrador-canvas.js`
 ...
 *
 * USO: `node js/gerador-glb/gerar_glb.js` — gera (sobrescreve)
...
const MostradorCanvas = require('../objecttypes/mostrador-canvas.js');
...
function main() {
  ...
  // relogio: 'mostrador' (textura PNG assada com js/objecttypes/mostrador-canvas.js,
  ...
  // continuam PARADOS, ver limitação documentada no topo).
  {
    ...
    // convenção de centro/raio que js/objecttypes/mostrador-canvas.js desenha
