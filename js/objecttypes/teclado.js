/* js/objecttypes/teclado.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['teclado']`), migrado pro registro
...
window.ObjectTypes.register('teclado', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'teclado' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    TecladoMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
