/* js/objecttypes/arquivo.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['arquivo']`), migrado pro registro
...
window.ObjectTypes.register('arquivo', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'arquivo' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ArquivoMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
