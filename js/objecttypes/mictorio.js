/* js/objecttypes/mictorio.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['mictorio']`), migrado pro registro
...
window.ObjectTypes.register('mictorio', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'mictorio' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    MictorioMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
