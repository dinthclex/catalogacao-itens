/* js/objecttypes/mouse2.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['mouse2']`), migrado pro registro
...
window.ObjectTypes.register('mouse2', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'mouse2' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    Mouse2MeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
