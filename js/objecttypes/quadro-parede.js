/* js/objecttypes/quadro-parede.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['quadro-parede']`), migrado pro registro
...
window.ObjectTypes.register('quadro-parede', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'quadro-parede' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    QuadroParedeMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
