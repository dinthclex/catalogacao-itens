/* js/objecttypes/monitor2.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['monitor2']`), migrado pro registro
...
window.ObjectTypes.register('monitor2', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'monitor2' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    Monitor2MeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
