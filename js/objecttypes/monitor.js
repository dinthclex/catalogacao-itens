/* js/objecttypes/monitor.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['monitor']`), migrado pro registro
...
window.ObjectTypes.register('monitor', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'monitor' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    MonitorMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
