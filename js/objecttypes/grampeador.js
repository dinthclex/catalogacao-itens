/* js/objecttypes/grampeador.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['grampeador']`), migrado pro registro
...
window.ObjectTypes.register('grampeador', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'grampeador' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    GrampeadorMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
