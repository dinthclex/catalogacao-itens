/* js/objecttypes/gabinete.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['gabinete']`), migrado pro registro
...
window.ObjectTypes.register('gabinete', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'gabinete' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    GabineteMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
