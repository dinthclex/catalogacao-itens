/* js/objecttypes/caixa-som.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['caixa-som']`), migrado pro registro
...
window.ObjectTypes.register('caixa-som', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'caixa-som' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    CaixaSomMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
