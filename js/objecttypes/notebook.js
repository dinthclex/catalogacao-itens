/* js/objecttypes/notebook.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['notebook']`), migrado pro registro
...
window.ObjectTypes.register('notebook', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'notebook' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    NotebookMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
