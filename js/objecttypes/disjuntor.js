/* js/objecttypes/disjuntor.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['disjuntor']`), migrado pro registro
...
window.ObjectTypes.register('disjuntor', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'disjuntor' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    DisjuntorMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
