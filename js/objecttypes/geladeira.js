/* js/objecttypes/geladeira.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['geladeira']`), migrado pro registro
...
window.ObjectTypes.register('geladeira', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'geladeira' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    GeladeiraMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
