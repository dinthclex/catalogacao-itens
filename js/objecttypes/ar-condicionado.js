/* js/objecttypes/ar-condicionado.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['ar-condicionado']`), migrado pro registro
 ...
 */
class ArCondicionadoMeshBuilder {
...
window.ObjectTypes.register('ar-condicionado', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'ar-condicionado' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ArCondicionadoMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
