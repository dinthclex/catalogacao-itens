/* js/objecttypes/lixeira.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['lixeira']`), migrado pro registro
...
window.ObjectTypes.register('lixeira', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'lixeira' && perfil.shape === 'cylinder'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    LixeiraMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
