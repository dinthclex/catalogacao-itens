/* js/objecttypes/pia.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['pia']`), migrado pro registro
...
window.ObjectTypes.register('pia', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'pia' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    PiaMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
