/* js/objecttypes/vaso-sanitario.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['vaso-sanitario']`), migrado pro registro
 ...
 */
class VasoSanitarioMeshBuilder {
...
window.ObjectTypes.register('vaso-sanitario', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'vaso-sanitario' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    VasoSanitarioMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
