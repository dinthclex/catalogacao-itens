/* js/objecttypes/elevador-cabine.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['elevador-cabine']`), migrado pro registro
 ...
 */
class ElevadorCabineMeshBuilder {
...
window.ObjectTypes.register('elevador-cabine', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'elevador-cabine' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ElevadorCabineMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
