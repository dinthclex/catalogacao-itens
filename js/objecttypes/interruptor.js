/* js/objecttypes/interruptor.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['interruptor']`), migrado pro registro
...
window.ObjectTypes.register('interruptor', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'interruptor' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    InterruptorMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
