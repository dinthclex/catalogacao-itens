/* js/objecttypes/estante.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['estante']`), migrado pro registro
...
window.ObjectTypes.register('estante', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'estante' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    EstanteMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
