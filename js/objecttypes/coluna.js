/* js/objecttypes/coluna.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['coluna']`), migrado pro registro
...
window.ObjectTypes.register('coluna', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'coluna' && perfil.shape === 'cylinder'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ColunaMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
