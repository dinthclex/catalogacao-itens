/* js/objecttypes/piso.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['piso']`), migrado pro registro
...
window.ObjectTypes.register('piso', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'piso' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    PisoMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
