/* js/objecttypes/quadro.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['quadro']`), migrado pro registro
...
window.ObjectTypes.register('quadro', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'quadro' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    QuadroMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
