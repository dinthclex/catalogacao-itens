/* js/objecttypes/bebedouro.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['bebedouro']`), migrado pro registro
...
window.ObjectTypes.register('bebedouro', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'bebedouro' && perfil.shape === 'cylinder'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    BebedouroMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
