/* js/objecttypes/impressora.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['impressora']`), migrado pro registro
...
window.ObjectTypes.register('impressora', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'impressora' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ImpressoraMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
