/* js/objecttypes/cafeteira.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['cafeteira']`), migrado pro registro
...
window.ObjectTypes.register('cafeteira', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'cafeteira' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    CafeteiraMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
