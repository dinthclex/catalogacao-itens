/* js/objecttypes/extintor.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['extintor']`), migrado pro registro
...
window.ObjectTypes.register('extintor', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'extintor' && perfil.shape === 'cylinder'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    ExtintorMeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
