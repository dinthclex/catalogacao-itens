/* js/objecttypes/gabinete2.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['gabinete2']`), migrado pro registro
...
window.ObjectTypes.register('gabinete2', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'gabinete2' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    Gabinete2MeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
