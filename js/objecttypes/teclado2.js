/* js/objecttypes/teclado2.js -- tipo de catálogo GENÉRICO (caixa/cilindro/
 * cone a partir de `OBJECT3D_PROFILES['teclado2']`), migrado pro registro
...
window.ObjectTypes.register('teclado2', {
  matchesMesh3D(obj, perfil) { return obj.tipo === 'teclado2' && perfil.shape === 'box'; },
  buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe) {
    Teclado2MeshBuilder.prototype.buildMesh3D(engine, obj, perfil, baseY, wireframe, colWireframe);
  },
});
