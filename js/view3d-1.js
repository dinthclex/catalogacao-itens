...
const View3D = {
  ...
  async _showCameraCard3D(cam) {
    ...
    el.innerHTML = `
      ...
      <!-- NOVO (12/09/2026), pedido verbatim: "ele deve ter uma folha de
           ...
           acrescentar informações." Mesmo padrão colapsável de
           "Propriedades da câmera" acima — ver js/objectstandard.js. -->
      <button type="button" class="btn secondary block sm" id="v3d-cam-hist-toggle" style="margin-top:6px">📜 Histórico deste objeto</button>
    ...
    this._container.appendChild(el);
    el.querySelector('#v3d-fc-close').onclick = () => el.remove();
    this._wireHistoricoCard(el, 'v3d-cam-hist', cam);
  ...
  async _showFotoPinCard3D(foto) {
    ...
    el.innerHTML = `
      ...
      <!-- NOVO (12/09/2026) — ver comentário grande em _showCameraCard3D/
           _wireHistoricoCard. Aqui foto é um registro de AmbientePhoto
           (DB), não uma entrada de map.objects — persistido via
           DB.saveAmbientePhoto (ver onclick abaixo), não DB.saveMap. -->
      <button type="button" class="btn secondary block sm" id="v3d-foto-hist-toggle" style="margin-top:6px">📜 Histórico deste objeto</button>
  ...
  _showObjectCard3D(obj) {
    ...
    el.innerHTML = `
      ...
      <!-- NOVO (12/09/2026) — ver comentário grande em _showCameraCard3D. -->
      <button type="button" class="btn secondary block sm" id="v3d-obj-hist-toggle" style="margin-top:6px">📜 Histórico deste objeto</button>
    ...
    this._container.appendChild(el);
    el.querySelector('#v3d-fc-close').onclick = () => el.remove();
    this._wireHistoricoCard(el, 'v3d-obj-hist', obj);
