/* assets/modelos/bebedouro.config.js
 ...
 * js/view3d.js, quando "Bebedouro" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('bebedouro', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Bebedouro (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Bebedouro (id='+entity.id+') clicado.');
