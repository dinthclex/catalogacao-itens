/* assets/modelos/lixeira.config.js
 ...
 * js/view3d.js, quando "Lixeira" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('lixeira', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Lixeira (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Lixeira (id='+entity.id+') clicado.');
