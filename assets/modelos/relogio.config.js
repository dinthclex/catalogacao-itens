/* assets/modelos/relogio.config.js
 ...
 * js/view3d.js, quando "Relógio" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('relogio', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Relógio (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Relógio (id='+entity.id+') clicado.');
