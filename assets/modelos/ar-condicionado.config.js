/* assets/modelos/ar-condicionado.config.js
 ...
 * js/view3d.js, quando "Ar-condicionado" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('ar-condicionado', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Ar-condicionado (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Ar-condicionado (id='+entity.id+') clicado.');
