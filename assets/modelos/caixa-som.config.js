/* assets/modelos/caixa-som.config.js
 ...
 * js/view3d.js, quando "Caixa de Som" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('caixa-som', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Caixa de Som (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Caixa de Som (id='+entity.id+') clicado.');
