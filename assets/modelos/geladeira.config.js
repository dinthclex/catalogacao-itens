/* assets/modelos/geladeira.config.js
 ...
 * js/view3d.js, quando "Geladeira" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('geladeira', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Geladeira (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Geladeira (id='+entity.id+') clicado.');
