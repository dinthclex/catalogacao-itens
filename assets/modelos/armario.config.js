/* assets/modelos/armario.config.js
 ...
 * js/view3d.js, quando "Armário" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('armario', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Armário (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Armário (id='+entity.id+') clicado.');
