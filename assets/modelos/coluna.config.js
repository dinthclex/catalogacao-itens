/* assets/modelos/coluna.config.js
 ...
 * js/view3d.js, quando "Coluna" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('coluna', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Coluna (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Coluna (id='+entity.id+') clicado.');
