/* assets/modelos/luminaria.config.js
 ...
 * js/view3d.js, quando "Luminária" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('luminaria', {
  ...
  malhaGlb: true, // [16/09/2026 UTC] NOVO — carrega assets/modelos/<tipo>.glb.js (gerado por assets/obj/gerador-glb/, ver js/glbmeshsource.js) -- tem prioridade sobre malhaEstatica acima (material PBR/emissivo/textura embutida de verdade); malhaEstatica fica como fallback caso o .glb.js algum dia seja removido/falhe ao parsear.
  id: 'luminaria',
  nome: 'Luminária',
  propriedades: { interativo: true },
  onModelSpawn(entity, ctx) {
    // roda 1x quando ESTE objeto aparece pela primeira vez na cena 3D
    //console.log('Objeto Luminária (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Luminária (id='+entity.id+') clicado.');
