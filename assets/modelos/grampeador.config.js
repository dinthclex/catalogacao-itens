/* assets/modelos/grampeador.config.js
 ...
 * js/view3d.js, quando "Grampeador" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('grampeador', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Grampeador (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Grampeador (id='+entity.id+') clicado.');
