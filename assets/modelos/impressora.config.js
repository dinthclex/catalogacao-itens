/* assets/modelos/impressora.config.js
 ...
 * js/view3d.js, quando "Impressora" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('impressora', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Impressora (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Impressora (id='+entity.id+') clicado.');
