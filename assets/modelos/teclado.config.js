/* assets/modelos/teclado.config.js
 ...
 * js/view3d.js, quando "Teclado" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('teclado', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Teclado (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Teclado (id='+entity.id+') clicado.');
