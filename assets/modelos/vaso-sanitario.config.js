/* assets/modelos/vaso-sanitario.config.js
 * NOVO (13/09/2026) — mesma correção de `ERR_FILE_NOT_FOUND` que
 * pia.config.js (ver comentário lá pro contexto completo): tipo já
 * existente (perfil em js/engine3d-profiles.js, usado pelos banheiros
 * gerados em js/geradores-salas.js) sem `.model.js` de auto-registro.
 * Decorativo, sem estado especial documentado.
 */
window.ObjectAssets.registerModel('vaso-sanitario', {
