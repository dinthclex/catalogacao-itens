 ...
 * js/view3d.js, quando "Mesa" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('mesa', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Mesa (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Mesa (id='+entity.id+') clicado.');
