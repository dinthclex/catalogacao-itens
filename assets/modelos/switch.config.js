/* assets/modelos/switch.config.js
 ...
 * js/view3d.js, quando "Switch" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('switch', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Switch (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Switch (id='+entity.id+') clicado.');
