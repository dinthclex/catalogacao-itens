/* assets/modelos/cadeira.config.js
 ...
 * js/view3d.js, quando "Cadeira" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('cadeira', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Cadeira (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Cadeira (id='+entity.id+') clicado.');
