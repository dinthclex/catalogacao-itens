/* ATENÇÃO — ESTE ARQUIVO NÃO É USADO PELO APP.
 * O objeto Escada é GERADO POR CÓDIGO (js/objecttypes/escada.js, a partir de
 * Largura, Profundidade, Altura e Degraus da janela de propriedades de cada
 * escada). O app não carrega nenhum modelo de arquivo para a Escada, nem no
 * "Ver em 3D" nem no Modelador. Mantido apenas como referência histórica. */
/* assets/modelos/escada.config.js
 ...
 * js/view3d.js, quando "Escada" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('escada', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Escada (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Escada (id='+entity.id+') clicado.');
