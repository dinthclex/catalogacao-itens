/* assets/modelos/ventilador.config.js
 ...
 * js/view3d.js, quando "Ventilador" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('ventilador', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Ventilador (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Ventilador (id='+entity.id+') clicado.');
