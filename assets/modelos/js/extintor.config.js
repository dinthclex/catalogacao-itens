/* assets/modelos/extintor.config.js
 ...
 * js/view3d.js, quando "Extintor" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('extintor', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Extintor (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Extintor (id='+entity.id+') clicado.');
