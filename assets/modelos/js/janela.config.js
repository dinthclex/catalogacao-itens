/* assets/modelos/janela.config.js
 ...
 * js/view3d.js, quando "Janela" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('janela', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Janela (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Janela (id='+entity.id+') clicado.');
