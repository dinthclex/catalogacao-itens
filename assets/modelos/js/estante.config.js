/* assets/modelos/estante.config.js
 ...
 * js/view3d.js, quando "Estante" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('estante', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Estante (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Estante (id='+entity.id+') clicado.');
