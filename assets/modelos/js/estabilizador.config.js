/* assets/modelos/estabilizador.config.js
 ...
 * js/view3d.js, quando "Estabilizador" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('estabilizador', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Estabilizador (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Estabilizador (id='+entity.id+') clicado.');
