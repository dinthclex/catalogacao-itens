/* assets/modelos/arquivo.config.js
 ...
 * js/view3d.js, quando "Arquivo" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('arquivo', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Arquivo (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Arquivo (id='+entity.id+') clicado.');
