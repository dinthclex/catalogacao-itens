/* assets/modelos/mouse.config.js
 ...
 * js/view3d.js, quando "Mouse" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('mouse', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Mouse (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Mouse (id='+entity.id+') clicado.');
