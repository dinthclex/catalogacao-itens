/* assets/modelos/quadro-parede.config.js
 * NOVO (15/09/2026) — tipo "quadro-parede" (quadro/pintura decorativo de
 * PAREDE — ver js/engine3d-profiles.js OBJECT3D_PROFILES['quadro-parede']
 * pras dimensões/cor e a explicação de por que é uma única cor
 * representativa, não moldura+tela de verdade). Segue EXATAMENTE o mesmo
 * padrão de gabinete2.config.js/relogio.config.js — mesmo comportamento de
 * clique (cartão genérico) por enquanto; customize aqui, sem mexer em
 * js/view3d.js, quando "Quadro de Parede" precisar de comportamento
 * próprio. */
window.ObjectAssets.registerModel('quadro-parede', {
