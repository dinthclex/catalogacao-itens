/* assets/modelos/telefone.config.js
 ...
 * js/view3d.js, quando "Telefone" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('telefone', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Telefone (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Telefone (id='+entity.id+') clicado.');
