/* assets/modelos/mouse2.config.js
 * NOVO (13/09/2026) — VARIANTE INDEPENDENTE do tipo "mouse", mesmo pedido/
 * padrão de gabinete2.config.js (ver comentário grande lá): segundo modelo
 * de Mouse como objeto INDEPENDENTE no catálogo, sem substituir o "mouse"
 * já existente. Perfil 3D em js/engine3d-profiles.js
 * (OBJECT3D_PROFILES.mouse2 — corpo maior/mais alto que a variante 1,
 * formato "ergonômico"). */
window.ObjectAssets.registerModel('mouse2', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Mouse (Ergonômico) (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Mouse (Ergonômico) (id='+entity.id+') clicado.');
