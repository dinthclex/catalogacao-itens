/* assets/modelos/planta.config.js
 ...
 * js/view3d.js, quando "Planta" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('planta', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Planta (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Planta (id='+entity.id+') clicado.');
