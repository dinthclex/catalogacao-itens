/* assets/modelos/quadro.config.js
 ...
 * js/view3d.js, quando "Quadro" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('quadro', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Quadro (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Quadro (id='+entity.id+') clicado.');
