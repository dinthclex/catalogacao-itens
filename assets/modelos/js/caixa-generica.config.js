/* assets/modelos/caixa-generica.config.js
 ...
 * js/view3d.js, quando "Caixa Genérica" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('caixa-generica', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Caixa Genérica (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Caixa Genérica (id='+entity.id+') clicado.');
