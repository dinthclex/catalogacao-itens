/* assets/modelos/calculadora.config.js
 ...
 * js/view3d.js, quando "Calculadora" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('calculadora', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Calculadora (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Calculadora (id='+entity.id+') clicado.');
