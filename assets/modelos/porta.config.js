/* assets/modelos/porta.config.js
 ...
 * js/view3d.js, quando "Porta" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('porta', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Porta (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Porta (id='+entity.id+') clicado.');
