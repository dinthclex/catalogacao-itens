/* assets/modelos/notebook.config.js
 ...
 * js/view3d.js, quando "Notebook" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('notebook', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Notebook (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Notebook (id='+entity.id+') clicado.');
