/* assets/modelos/poste.config.js
 ...
 * js/view3d.js, quando "Poste" precisar de comportamento próprio. */
window.ObjectAssets.registerModel('poste', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Poste (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Poste (id='+entity.id+') clicado.');
