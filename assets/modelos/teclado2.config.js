/* assets/modelos/teclado2.config.js
 * NOVO (13/09/2026) — VARIANTE INDEPENDENTE do tipo "teclado", mesmo
 * pedido/padrão de gabinete2.config.js (ver comentário grande lá): segundo
 * modelo de Teclado como objeto INDEPENDENTE no catálogo, sem substituir o
 * "teclado" já existente. Perfil 3D em js/engine3d-profiles.js
 * (OBJECT3D_PROFILES.teclado2 — mais estreito que a variante 1, formato
 * "compacto" sem teclado numérico à direita). */
window.ObjectAssets.registerModel('teclado2', {
  ...
  onModelSpawn(entity, ctx) {
    ...
    //console.log('Objeto Teclado (Compacto) (id='+entity.id+') criado na cena.');
  },
  onModelClick(entity, ctx) {
    // roda ao clicar com o botão esquerdo NESTE objeto
    //console.log('Objeto Teclado (Compacto) (id='+entity.id+') clicado.');
